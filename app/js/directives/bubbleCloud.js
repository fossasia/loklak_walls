...
var directivesModule = require('./_index.js');
    ...
    function bubbleCloudDir() {
        ...
        var link = function ($scope, $el, $attrs) {
            ...
            // Add to data set if above min count
            function processNodeData(obj) {
                var newDataSet = [];
                for(var prop in obj) {
            ...
            function update(mentionFreq) {
                ...
                if(Object.keys(mentionFreq).length === 0) {
                ...
                var nodes = bubble.nodes(processNodeData(mentionFreq))
...
directivesModule.directive('bubbleCloud', [ bubbleCloudDir])